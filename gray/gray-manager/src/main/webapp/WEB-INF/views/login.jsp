...
<div style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231);border-image:none;width:400px;text-align: center;">
    <form method="post" id="loginform">
        ...
        <P style="padding: 30px 0px 10px; position: relative;">
            ...
            <input class="ipt" type="text" name="username" value="admin" placeholder="请输入用户名或邮箱"/>
        </P>
        <P style="position: relative;">
            <span class="p_logo"></span>
            <input class="ipt" id="password" type="password" name="password" value="admin" placeholder="请输入密码"/>
        </P>
