...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $.ajax({  
            type : 'POST',  
            dataType : "json",  
            url : '${path }/resource/tree?datatime='+new Date() ,  
...
<body>
    ...
    <div id="index_layout">
        <div data-options="region:'north',border:false" style="overflow: hidden;">
            <div>
                <span style="float: right; padding-right: 20px; margin-top: 30px; color: #333">
                    <b><shiro:principal></shiro:principal></b>&nbsp;&nbsp;，你好！ 
        ...
        <div  data-options="region:'west',split:true" title="导航菜单" style="width: 180px; overflow: hidden;overflow-y:auto; padding:0px">
        	<div id="layout_west_accordion" class="easyui-accordion" data-options="fit:true,border:false,nimate:true,lines:true"></div>
        </div>
        <div data-options="region:'center'" style="overflow: hidden;">
            <div id="index_tabs" style="overflow: hidden;">
                <div title="欢迎使用" data-options="iconCls:'fi-home',border:false" style="overflow: hidden;">
                    11111111111111
                </div>
            </div>
        </div>
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 power by <a href="#" >XXX灰度管理系统</a></div>
    </div>
    <div id="tabsMenu">
